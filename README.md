...
Here’s a small “Usage example” section you can paste straight into your README.md (I’d put it just after Basic Workflow):
...
```powershell
cd "C:\Path\To\ROOMS AND ROOM LIST MIGRATION\Rooms_Migration\1-Scripts"
.\1-Export-RoomsAndRoomLists_OnPrem.ps1


This creates the Export CSV folder with Rooms_OnPrem_*.csv, RoomLists_OnPrem_*.csv, etc.
...
- On GitHub: open your repo ➜ click `README.md` ➜ click the ✏️ pencil ➜ paste this section where you want it ➜ **Commit changes**.
- Or locally: `notepad README.md`, paste it in, then:

```powershell
git add README.md
git commit -m "Add usage example section"
git push
